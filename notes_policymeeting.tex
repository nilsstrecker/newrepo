...
\hypersetup{
  pdftitle={Notes for Friday Policy Meeting},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\title{Notes for Friday Policy Meeting}
\author{}
\date{}
...
\hypertarget{possible-policies}{%
\subsection{Possible Policies}\label{possible-policies}}
...
\hypertarget{lessons-learned-from-pilot}{%
\subsection{Lessons learned from
pilot}\label{lessons-learned-from-pilot}}
...
\item
  ...
  \end{itemize}
\item
  Decisions are typically made in private, not even in (closed) council
  meetings
\item
  Details about specific events are often hard to come by, very
  dependent on memory of involved persons --\textgreater{} Time is of
  the essence
\item
  Could be advantageous to have only a few important events
\item
  Important council members are often personally involved in issues, no
  "need" for outside forces to influence them
\end{itemize}
